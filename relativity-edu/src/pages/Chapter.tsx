    ...
    return (
      <div className="ml-64 pt-16">
        <div className="container mx-auto px-6 py-8 max-w-3xl">
          <Quiz quiz={quiz} onComplete={handleQuizComplete} onBack={() => setShowQuiz(false)} />
        </div>
      </div>
    )
  }
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <div className="mb-6">
              ...
              <h1 className="text-3xl font-bold mb-2">第{chapter.id}章：{chapter.title}</h1>
            ...
            <div className="flex items-center justify-between">
              <Button variant="outline" onClick={handlePrevSection} disabled={currentSection === 0} className="gap-2">
          ...
          >
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-4">
                <p className="text-sm text-muted-foreground text-center">拖动鼠标旋转视角，滚轮缩放</p>
              </CardContent>
            </Card>
          </motion.div>
        </div>
